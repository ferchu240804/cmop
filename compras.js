...
const products = [
    ...
    },
    {
        name: "Iphone XR",
        price: 259.99,
        description: "lo mas nuevo en tecnologia",
        image: "iphone XR.png"
    },
  ];
  
  // Obtener saldo inicial desde localStorage o establecer un valor predeterminado
  let saldoRestante = parseFloat(localStorage.getItem('saldoRestante')) || 10000000;
  ...
  // Actualizar saldo en el DOM y en localStorage
  const actualizarSaldo = (nuevoSaldo) => {
    saldoRestante = nuevoSaldo;
    localStorage.setItem('saldoRestante', saldoRestante); // Guardar en localStorage
    saldoContainer.innerHTML = `<strong>Saldo restante:</strong> $${saldoRestante.toLocaleString()}`;
  };
